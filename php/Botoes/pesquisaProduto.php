...
<body>
  ...
  <section class="container-table">
    ...
    <form class="form" method="POST" action="pesquisaProduto.php">
      <div class="pesquisa">
        <label class="item-pesquisa space" for="nomeProduto">Nome:</label>
        <input class="item-pesquisa" type="text" id="nomeProduto" name="nomeProduto" maxlength="40" placeholder="digite aqui o nome do produto....">
